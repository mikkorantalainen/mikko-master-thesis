...
\begin{kuva}
\includegraphics[width=4.5cm]{kuvat/oppimappi-big-picture}
\caption{Oppimapin rakenne kerroksina}
\label{fig:oppimappi-big-picture}
\end{kuva}


Kuvassa \ref{fig:oppimappi-schema-current} on  esitetty loppujen
lopuksi käytetty ratkaisumalli. Tässäkin luokkahierarkia on
ensisilmäyksellä vähintäänkin outo, mutta ratkaisun taustalla
kummittelee vaillinainen oliotuki PHP-kielessä. Tätä kirjoittaessa PHP5
on jo ilmestynyt ja siinä joitakin ongelmia onkin korjattu, mutta sen
...
edelliseen näkymään palaaminen myös historian kautta avatuissa

...
toiminta"-palkin kautta ja toiminnot tallennetaan aina lomakkeen lopussa
olevasta ``Tallenna''-painikkeella. Mikään, mikä ei näytä painikkeelta
ei tee järjestelmään pysyviä, kaikkia käyttäjiä koskevia muutoksia ja
...
henkilö $B$ poistaa dokumentin $X$. Jos $A$ nyt yrittää tallentaa
tekemänsä muutokset, niin haluttu tulos ei ole itsestään selvä.
Oppimappi ei toistaiseksi osaa käsitellä tilannetta, jossa dokumentin
$X$ muutokset yritetään tallentaa, mutta dokumenttia $X$ ei ole enää
olemassa. Näin tapahtuessa käyttäjälle annetaan vain virheilmoitus,
jossa toistetaan käyttäjän syöttämä tieto, jotta hän voi kopioida sen
talteen toiseen ohjelmaan. Ongelmana on, pitäisikö järjestelmän
palauttaa dokumentti $X$ järjestelmään (miten? Eikö dokumenttia $X$
voikaan oikeasti koskaan poistaa?) ja tallentaa muutos. Vai pitäisikö
muutokset tallentaa uutena dokumenttina? Jos, niin minne ja millä
nimellä? Myös hakemisto, jossa tiedosto oli, on voitu poistaa.

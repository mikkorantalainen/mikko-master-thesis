...
suoraan mille tahansa edelliselle tasolle. Kaikki sisällössä olevat linkit ovat sinisiä ja alleviivattuja, joten ne on helppo havaita.
...
henkilö $A$ aloittaa dokumentin $X$ muokkaamisen ja tämän jälkeen
henkilö $B$ poistaa dokumentin $X$. Virhetilannetta, jossa dokumentin
$X$ muutokset yritetään tallentaa, mutta dokumenttia $X$ ei ole enää
olemassa, ei ainakaan toistaiseksi käsitellä Oppimappi"-sovelluksessa.
Ongelmana on, pitäisikö järjestelmän palauttaa dokumentti $X$
järjestelmään (miten? Eikö dokumenttia $X$ voikaan oikeasti koskaan
poistaa?) ja tallentaa muutos. Vai pitäisikö muutokset tallentaa uutena
dokumenttina? Jos, niin minne -- myös hakemisto, jossa tiedosto oli on voitu poistaa -- ja millä nimellä?

...
kiinnostunut itse sisällöstä, ei mahdollisista toiminnoista. Samoin
kaikki sovelluksen toiminnallisuus on käytettävissä ilman kuvien
lataamista tai JavaScript"-tukea.
...
talteen toiseen paikkaan. Ongelmana on, pitäisikö järjestelmän
palauttaa dokumentti $X$ järjestelmään. Jos tämän pitää olla
mahdollista, ei järjestelmä voikaan koskaan poistaa dokumenttia $X$
oikeasti, ainoastaan piilottaa se näkyvistä. Vaihtoehtoisesti muokattu
sisältö voitaisiin tallentaa uudeksi tiedostoksi. Tässä mallissa
ongelmana on, mihin uusi tiedosto pitäisi luoda? Myös hakemisto, jossa
tiedosto oli, on voitu poistaa.

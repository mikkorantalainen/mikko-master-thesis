...
Esimerkiksi Microsoft Windows -käyttöjärjestelmässä toimiva Microsoft Word -ohjelma on tälläinen. Sen tekijät ovat tehneet oletuksen, että käyttöjärjestelmä ilmoittaa kaikista ohjelmalle tehtävistä asioista. Tämä ilmoitus tapahtuu käytännössä siten, että käyttöjärjestelmä lähettää ohjelmalle tapahtumia. Käyttöjärjestelmä on suunniteltu siten, että kaikista ohjelmaa kiinnostavista tapahtumista todellakin menee tieto ohjelmalle asti ja tapahtumankäsittelijä toimiikin hyvin. Selainkäyttöiset ohjelmat eivät kuitenkaan toimi tälläisessä ympäristössä.
